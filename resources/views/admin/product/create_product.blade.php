                            ...
                            <div class="col-md-6 col-lg-12 col-xl-12 order-0 mb-6">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body  m-1">
                                        <form class=" row" enctype="multipart/form-data" action="/admin/product/store"
                                            method="post">
                                            @csrf
                                            <div class="form-floating col-lg-5 m-1">
                                                <input type="text" class="form-control" value="{{ old('name') }}"
                                                    id="name" name="name" placeholder="fly down the sky"
                                            ...
                                            <div class="form-floating col-lg-4 m-1">
                                                <input type="date" class="form-control" value="{{ old('manufactury_date') }}"
                                            ...
                                            <div class="form-floating col-lg-3 m-1">
                                                <input type="number" class="form-control" value="{{ old('quantity_in_stock') }}"
                                            ...
                                            <div class="form-floating col-lg-3 m-1">
                                                <input type="number" step="0.01" class="form-control" value="{{ old('unit_price') }}"
                                            ...
                                            <div class="form-floating col-lg-3 m-1">
                                                <input type="number" step="0.01" class="form-control" value="{{ old('selling_price') }}"
