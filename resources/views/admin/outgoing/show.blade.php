<!doctype html>
<x-header title="{{ $outgoing->product_name }}" />
                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-title mb-0">
                                            <h5 class="mb-1 me-2">View outgoing goods </h5>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="card mb-6 shadow border">
                                            <div class="card-body">
                                                ...
                                                <h2 class="card-title text-capitalize mb-1">{{ $outgoing->productname }} </h2>
                                                <div class="card-subtitle mb-4">{{ $outgoing->created_at->diffForHumans() }}
                                                </div>
                                                <p class="card-text">
                                                    Unit price{{ $outgoing->price }} GHS
                                                </p>
                                                 <p class="card-text">
                                                   <b> Customer name</b> {{ $outgoing->customer->name }}
                                                </p>
                                                 <p class="card-text">
                                                   <b> Product</b> {{ $outgoing->product->name }}
                                                </p>
        
                                                 <p class="card-text">
                                                   <b> total</b> {{ $outgoing->total }}
                                                </p>
                                                <a href="/admin/outgoing/{{ $outgoing->id }}/edit"
