                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-title mb-0">
                                            <h5 class="mb-1 me-2">edit brand</h5>
                                        </div>

                                    </div>
                                    <div class="card-body">
                                        <form class="row" action="/admin/brand/{{ $brand->id }}" method="post">
                                            @csrf
                                            @method("put")
                                            ...
                                            <textarea placeholder="type here" class="form-control col-lg-11 m-1"  name="description" id="description" cols="30" rows="10">{{ $brand->description }}</textarea>
                                             @error("description")
                                               <p class="text-danger">
                                                {{ $message }}
                                               </p>
                                          ...
                                          <input class="btn btn-primary m-3" name="update" type="submit" value="update brand">
                                        </form>
                                    </div>
                                </div>
                            </div>
