                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-title mb-0">
                                            <h5 class="mb-1 me-2">all suppliers</h5>
                                        </div>
                                        @if ( session("message"))
                                                ...
                                                <table id="basic" class="table dataTable border "
                                                    ...
                                                    <tbody class="table-border-bottom-0">
                                                        @foreach ($suppliers as $supplier )
                                                            ...
                                                            <td> {{  Str::words( $supplier->address,15, '...') }}</td>
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item"
                                                                            href="/admin/supplier/{{$supplier->id }}/edit"><i
                                                                        ...
                                                                        <form action="/admin/supplier/{{$supplier->id }}" method="post">
                                                                            ...
                                                                            <a class="dropdown-item"
                                                                            href="/admin/supplier/{{ $supplier->id }}"><i
