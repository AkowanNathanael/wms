                                    ...
                                    <div class="card-body">
                                        <div class="card mb-6 shadow border">
                                            <div class="card-body">
                                                ...
                                                <div class="card-subtitle mb-4">{{ $supplier->created_at->diffForHumans() }}</div>
                                                <p class="card-text">
                                                    <b>Address </b>: {{ $supplier->address }} || <b>phone </b>: {{ $supplier->phone }}
                                                </p>
                                                 <p class="card-text">
                                                    <b>Email </b>: {{ $supplier->email }} || <b>gender </b>: {{ $supplier->gender }}
                                                </p>
                                                <a href="/admin/supplier/{{ $supplier->id }}/edit" class="card-link inline-block btn btn-success">edit</a>
