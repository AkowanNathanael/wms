<!doctype html>
<x-header title="create suppliers" />
                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-title mb-0">
                                            <h5 class="mb-1 me-2">Add supplier</h5>
                                        </div>

                                    </div>
                                    <div class="card-body">
                                        <form class="row" action="/admin/supplier/store" method="post">
                                            @csrf
                                          ...
                                          <input class="btn btn-primary m-3" name="submit" type="submit" value="add supplier">
                                        </form>
                                    </div>
                                </div>
                            </div>
