                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-title mb-0">
                                            <h5 class="mb-1 me-2">View warehouse</h5>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="card mb-6 shadow border">
                                            <div class="card-body">
                                                ...
                                                <div class="card-subtitle mb-4">{{ $warehouse->created_at->diffForHumans() }}</div>
                                                <p class="card-text">
                                                    {{ $warehouse->location }}
                                                </p>
                                                <a href="/admin/warehouse/{{ $warehouse->id }}/edit" class="card-link inline-block btn btn-success">edit</a>
