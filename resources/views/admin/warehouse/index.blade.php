                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-title mb-0">
                                            <h5 class="mb-1 me-2">all warehouses</h5>
                                        </div>
                                        @if ( session("message"))
                                                ...
                                                <table id="basic" class="table dataTable border "
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-dt-column="1" rowspan="1" colspan="1"
                                                                class="dt-orderable-asc dt-orderable-desc">location
                                                            </th>
                                                    ...
                                                    <tbody class="table-border-bottom-0">
                                                        @foreach ($warehouses as $warehouse )
                                                            ...
                                                            <td> {{  Str::words( $warehouse->location,25, '...') }}</td>
                                                            </td>
                                                            <td>
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item"
                                                                            href="/admin/warehouse/{{$warehouse->id }}/edit"><i
                                                                                class="icon-base bx bx-edit-alt me-1"></i>
                                                                            Edit</a>
                                                                        <form action="/admin/warehouse/{{$warehouse->id }}" method="post">
                                                                            @csrf
                                                                            @method("delete")
                                                                            ...
                                                                            <a class="dropdown-item"
                                                                            href="/admin/warehouse/{{ $warehouse->id }}"><i
