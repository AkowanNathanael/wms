                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-title mb-0">
                                            <h5 class="mb-1 me-2">all customers</h5>
                                        </div>
                                        @if ( session("message"))
                                                ...
                                                <table id="basic" class="table dataTable border "
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-dt-column="1" rowspan="1" colspan="1"
                                                                class="dt-orderable-asc dt-orderable-desc">Address
                                                            </th>
                                                             <th data-dt-column="1" rowspan="1" colspan="1"
                                                                class="dt-orderable-asc dt-orderable-desc">email
                                                            </th>
                                                             <th data-dt-column="1" rowspan="1" colspan="1"
                                                                class="dt-orderable-asc dt-orderable-desc">phone
                                                            </th>
                                                             <th data-dt-column="1" rowspan="1" colspan="1"
                                                                class="dt-orderable-asc dt-orderable-desc">gender
                                                            </th>
                                                    ...
                                                    <tbody class="table-border-bottom-0">
                                                        @foreach ($customers as $customer )
                                                            ...
                                                            <td> {{  Str::words( $customer->address,15, '...') }}</td>
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item"
                                                                            href="/admin/customer/{{$customer->id }}/edit"><i
                                                                        ...
                                                                        <form action="/admin/customer/{{$customer->id }}" method="post">
                                                                            ...
                                                                            <a class="dropdown-item"
                                                                            href="/admin/customer/{{ $customer->id }}"><i
