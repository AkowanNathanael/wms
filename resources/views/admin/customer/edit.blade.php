                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-title mb-0">
                                            <h5 class="mb-1 me-2">edit customer</h5>
                                        </div>

                                    </div>
                                    <div class="card-body">
                                        <form class="row" action="/admin/customer/{{ $customer->id }}" method="post">
                                            @csrf
                                            @method("put")
                                            <div class="form-floating col-lg-11 m-1">
                                             ...
                                             <div class="form-floating col-lg-3 m-1">
                                                <input type="number" maxlength="10"  pattern="[0-1]{10}"  class="form-control"  value="{{ $customer->phone  }}" id="phone" name="phone"
                                            ...
                                            <textarea placeholder="type here" class="form-control col-lg-11 m-1"  name="address" id="address" cols="30" rows="10">{{ $customer->address }}</textarea>
                                             @error("address")
                                               <p class="text-danger">
                                                {{ $message }}
                                               </p>
                                             @enderror
                                          <input class="btn btn-primary m-3" name="update" type="submit" value="update customer">
                                        </form>
                                    </div>
                                </div>
                            </div>
