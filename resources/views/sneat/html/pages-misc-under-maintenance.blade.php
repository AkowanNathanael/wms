...
<html lang="en" class="layout-wide" data-assets-path="dist/" data-template="vertical-menu-template-free">
  <head>
    <meta charset="utf-8" />
    <meta
      name="viewport"
    ...
    <title>Demo: Under Maintenance - Pages | Sneat - Bootstrap Dashboard FREE</title>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="dist/vendor/css/pages/page-misc.css" />
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <a href="/auth-index" class="btn btn-primary">Back to home</a>
        <div class="mt-6">
          <img
            src="dist/img/illustrations/girl-doing-yoga-light.png"
