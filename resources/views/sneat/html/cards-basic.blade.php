...
<html
  ...
  <head>
    ...
    <title>Demo: Cards basic - UI elements | Sneat - Bootstrap Dashboard FREE</title>
  ...
  <body>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="/auth-layouts-without-navbar" class="menu-link">
                    <div class="text-truncate" data-i18n="Without navbar">Without navbar</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/auth-layouts-fluid" class="menu-link">
                    <div class="text-truncate" data-i18n="Fluid">Fluid</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/auth-layouts-container" class="menu-link">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="/auth-buttons" class="menu-link">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row mb-12 g-6">
                <div class="col-md-6 col-lg-4">
                  <div class="card h-100">
                    <img class="card-img-top" src="dist/img/elements/2.png" alt="Card image cap" />
                    <div class="card-body">
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card h-100">
                    ...
                    <img class="img-fluid" src="dist/img/elements/5.png" alt="Card image cap" />
                    <div class="card-body">
              ...
              <div class="row mb-12 g-6">
                ...
                <div class="col-md-6 col-lg-4">
                  ...
                  <div class="card">
                    <img class="card-img-top" src="dist/img/elements/5.png" alt="Card image cap" />
                    <div class="card-body">
                      <p class="card-text">
                        Some quick example text to build on the card title and make up the bulk of the card's content.
                      </p>
                ...
                <div class="col-md-6 col-lg-4">
                  ...
                  <div class="card">
                    <img class="card-img-top" src="dist/img/elements/7.png" alt="Card image cap" />
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
              ...
              <div class="row mb-12 g-6">
                ...
                <div class="col-md-6 col-xl-4">
                  <div class="card">
                    ...
                    <img class="card-img-bottom" src="dist/img/elements/6.png" alt="Card image cap" />
                  </div>
                </div>
                <div class="col-md-6 col-xl-4">
                  <div class="card text-bg-dark border-0">
                    <img class="card-img" src="dist/img/elements/14.png" alt="Card image" />
                ...
                <div class="col-md">
                  <div class="card">
                    <div class="d-flex flex-md-row flex-column">
                      <div>
                        <img class="card-img card-img-left" src="dist/img/elements/18.png" alt="Card image" />
                      </div>
                      <div>
                        <div class="card-body">
                          <h5 class="card-title">Card title</h5>
                ...
                <div class="col-md">
                  <div class="card">
                    <div class="d-flex flex-md-row flex-column">
                      ...
                      <div>
                        <img class="card-img card-img-right" src="dist/img/elements/19.png" alt="Card image" />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card-group mb-12">
                <div class="card">
                  <img class="card-img-top" src="dist/img/elements/4.png" alt="Card image cap" />
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">
                      This is a wider card with supporting text below as a natural lead-in to additional content. This
                ...
                <div class="card">
                  <img class="card-img-top" src="dist/img/elements/1.png" alt="Card image cap" />
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">
                      This is a wider card with supporting text below as a natural lead-in to additional content. This
              ...
              <div class="row row-cols-1 row-cols-md-3 g-6 mb-12">
                <div class="col">
                  <div class="card h-100">
                    <img class="card-img-top" src="dist/img/elements/15.png" alt="Card image cap" />
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">
                ...
                <div class="col">
                  <div class="card h-100">
                    <img class="card-img-top" src="dist/img/elements/16.png" alt="Card image cap" />
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">
                        This is a longer card with supporting text below as a natural lead-in to additional content.
                ...
                <div class="col">
                  <div class="card h-100">
                    <img class="card-img-top" src="dist/img/elements/17.png" alt="Card image cap" />
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">
                        This is a longer card with supporting text below as a natural lead-in to additional content.
                ...
                <div class="col">
                  <div class="card h-100">
                    <img class="card-img-top" src="dist/img/elements/11.png" alt="Card image cap" />
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">
                        This is a longer card with supporting text below as a natural lead-in to additional content.
                ...
                <div class="col">
                  <div class="card h-100">
                    <img class="card-img-top" src="dist/img/elements/12.png" alt="Card image cap" />
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">
                        This is a longer card with supporting text below as a natural lead-in to additional content.
                ...
                <div class="col">
                  <div class="card h-100">
                    <img class="card-img-top" src="dist/img/elements/13.png" alt="Card image cap" />
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">
                        This is a longer card with supporting text below as a natural lead-in to additional content.
              ...
              <div class="row g-6" data-masonry='{"percentPosition": true }'>
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card">
                    <img class="card-img-top" src="dist/img/elements/3.png" alt="Card image cap" />
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                      <p class="card-text">
                        This card has supporting text below as a natural lead-in to additional content.
                ...
                <div class="col-sm-6 col-lg-4">
                  <div class="card">
                    <img class="card-img" src="dist/img/elements/4.png" alt="Card image cap" />
                  </div>
                </div>
                <div class="col-sm-6 col-lg-4">
    ...
    <!-- Vendors JS -->
    <script src="{{ asset('dist/vendor/libs/masonry/masonry.js') }}"></script>
