...
<html
  ...
  <head>
    ...
    <!-- Core CSS -->
    <!-- build:cssdist/vendor/css/theme.css  -->
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{ asset('dist/vendor/css/pages/page-auth.css') }}" />
  ...
  <body>
          ...
          <div class="card px-sm-6 px-0">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center mb-6">
                <a href="/auth-index" class="app-brand-link gap-2">
              ...
              <form id="formAuthentication" class="mb-6" action="/auth-index">
                <div class="mb-6">
    ...
    <script src="{{ asset('{{ asset('dist/vendor/libs/popper/popper.js') }}') }}"></script>
