...
<html
  ...
  <head>
    ...
    <title>Demo: Dropdowns - UI elements | Sneat - Bootstrap Dashboard FREE</title>
                      ...
                      <div class="demo-inline-spacing">
                        <div class="btn-group" id="dropdown-icon-demo">
                          <button
                            ...
                            data-bs-toggle="dropdown"
                            aria-expanded="false">
                            <i class="icon-base bx bx-menu me-1"></i> With Icon
                          </button>
                          <ul class="dropdown-menu">
                            <li>
                              <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"
                                ><i class="icon-base bx bx-chevron-right"></i>Action</a
                              >
                            </li>
                            <li>
                              <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"
                                ><i class="icon-base bx bx-chevron-right"></i>Another action</a
                              >
                            </li>
                            <li>
                              <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"
                                ><i class="icon-base bx bx-chevron-right"></i>Something else here</a
                              >
                            </li>
                            <li>
                              <hr class="dropdown-divider" />
                            ...
                            <li>
                              <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"
                                ><i class="icon-base bx bx-chevron-right"></i>Separated link</a
                              >
                            </li>
                          </ul>
                        </div>
