                        ...
                        <td>
                          <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
                            <li
                              ...
                              title="Lilian Fuller">
                              <img src="dist/img/avatars/2.png" alt="Avatar" class="rounded-circle" />
                            </li>
                            <li
                              data-bs-toggle="tooltip"
                              data-popup="tooltip-custom"
                              ...
                              <img src="dist/img/avatars/3.png" alt="Avatar" class="rounded-circle" />
                            </li>
                            <li
                              data-bs-toggle="tooltip"
                              data-popup="tooltip-custom"
                              ...
                              <img src="dist/img/avatars/4.png" alt="Avatar" class="rounded-circle" />
                            </li>
                          </ul>
                        </td>
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      <tr>
                        <td class="rounded-start-bottom">
                          <i class="icon-base bx bxl-bootstrap icon-md text-primary me-3"></i>
                          <span>Bootstrap Project</span>
                        </td>
                        <td>Jerry Milton</td>
                        <td>
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      <tr class="table-default">
                        <td>
                          <i class="icon-base bx bxl-sketch icon-md text-warning me-4"></i> <span>Sketch Project</span>
                        </td>
                        <td>Ronnie Shane</td>
                        <td>
                          <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
                      ...
                      <tr class="table-dark">
                        <td class="rounded-start-bottom">
                          <i class="icon-base bx bxl-bootstrap icon-md text-primary me-4"></i> <span>Bootstrap UI</span>
                        </td>
                        <td>Jerry Milton</td>
                        <td>
                          <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
                        ...
                        <td colspan="5">
                          <table class="table mb-0 table-light">
                            ...
                            <tbody>
                              <tr>
                                <td>
                                  <i class="icon-base bx bxl-react icon-md text-info me-4"></i>
                              ...
                              <tr>
                                <td>
                                  <i class="icon-base bx bxl-vuejs icon-md text-success me-4"></i>
