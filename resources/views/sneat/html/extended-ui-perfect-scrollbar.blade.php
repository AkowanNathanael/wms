...
<html
  ...
  <head>
    ...
    <title>Demo: Perfect Scrollbar - Extended UI | Sneat - Bootstrap Dashboard FREE</title>
  ...
  <body>
                ...
                <div class="col-md-6 col-sm-12">
                  <div class="card overflow-hidden" style="height: 300px">
                    ...
                    <div class="card-body" id="horizontal-example">
                      <img src="dist/img/backgrounds/1.jpg" alt="scrollbar-image" />
                    </div>
                  </div>
                </div>
                <!--/ Horizontal Scrollbar -->
    ...
    <!-- Page JS -->
    <script src="dist/js/extended-ui-perfect-scrollbar.js"></script>
