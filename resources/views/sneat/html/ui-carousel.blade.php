...
<html
  ...
  <head>
    ...
    <title>Demo: Carousel - UI elements | Sneat - Bootstrap Dashboard FREE</title>
              ...
              <div class="row g-6">
                  ...
                  <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="dist/img/elements/3.png" alt="First slide" />
                      ...
                      <div class="carousel-item">
                        <img class="d-block w-100" src="dist/img/elements/4.png" alt="Second slide" />
                        <div class="carousel-caption d-none d-md-block">
                          <h3>Second slide</h3>
                      ...
                      <div class="carousel-item">
                        <img class="d-block w-100" src="dist/img/elements/5.png" alt="Third slide" />
                        <div class="carousel-caption d-none d-md-block">
                          <h3>Third slide</h3>
                ...
                <div class="col-md">
                  ...
                  <div
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="dist/img/elements/7.png" alt="First slide" />
                        <div class="carousel-caption d-none d-md-block">
                          <h3>First slide</h3>
                          <p>Eos mutat malis maluisset et, agam ancillae quo te, in vim congue pertinacia.</p>
                        </div>
                      ...
                      <div class="carousel-item">
                        <img class="d-block w-100" src="dist/img/elements/8.png" alt="Second slide" />
                        <div class="carousel-caption d-none d-md-block">
                          <h3>Second slide</h3>
                          <p>In numquam omittam sea.</p>
                        </div>
                      ...
                      <div class="carousel-item">
                        <img class="d-block w-100" src="dist/img/elements/10.png" alt="Third slide" />
                        <div class="carousel-caption d-none d-md-block">
                          <h3>Third slide</h3>
                          <p>Lorem ipsum dolor sit amet, virtute consequat ea qui, minim graeco mel no.</p>
                        </div>
