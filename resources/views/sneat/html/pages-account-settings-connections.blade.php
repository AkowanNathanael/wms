                ...
                <div class="col-md-12">
                  <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-md-0 gap-2">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="/auth-pages-notifications"
                        ...
                        <div class="card-body">
                          <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                              <img src="dist/img/icons/brands/google.png" alt="google" class="me-4" height="32" />
                            </div>
                          ...
                          <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                              <img src="dist/img/icons/brands/slack.png" alt="slack" class="me-4" height="32" />
                            </div>
                            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                              <div class="mb-sm-0 mb-2">
                          ...
                          <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                              <img src="dist/img/icons/brands/github.png" alt="github" class="me-4" height="32" />
                            </div>
                            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                              <div class="mb-sm-0 mb-2">
                          ...
                          <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                              <img
                                src="dist/img/icons/brands/mailchimp.png"
                                alt="mailchimp"
                                class="me-4"
                                height="32" />
                            </div>
                          ...
                          <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                              <img src="dist/img/icons/brands/asana.png" alt="asana" class="me-4" height="32" />
                            </div>
                            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                              <div class="mb-sm-0 mb-2">
                      ...
                      <div class="col-md-6 col-12">
                        ...
                        <div class="card-body">
                          ...
                          <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                              <img
                                src="dist/img/icons/brands/facebook.png"
                                alt="facebook"
                                class="me-4"
                                height="32" />
                            </div>
                          ...
                          <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                              <img
                                src="dist/img/icons/brands/twitter.png"
                                alt="twitter"
                                class="me-4"
                                height="32" />
                            </div>
                          ...
                          <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                              <img
                                src="dist/img/icons/brands/instagram.png"
                                alt="instagram"
                                class="me-4"
                                height="32" />
                            </div>
                          ...
                          <div class="d-flex mb-4 align-items-center">
                            <div class="flex-shrink-0">
                              <img
                                src="dist/img/icons/brands/dribbble.png"
                                alt="dribbble"
                                class="me-4"
                                height="32" />
                            </div>
                          ...
                          <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                              <img
                                src="dist/img/icons/brands/behance.png"
                                alt="behance"
                                class="me-4"
                                height="32" />
                            </div>
